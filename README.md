...
OWASP bcrypt
OWASP warn de rutas incorrectas y login fallidos
OWASP destruir sesión
...
loggers, diferentes builders para dev y prod. Aparte diferentes configuraciones de niveles y formatos y transportes
